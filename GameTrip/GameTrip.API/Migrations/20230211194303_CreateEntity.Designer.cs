...
namespace GameTrip.API.Migrations
{
    ...
    [Migration("20230211194303_CreateEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameTrip.API.Data.Comment", b =>
                {
            ...
            modelBuilder.Entity("GameTrip.API.Data.Game", b =>
                {
            ...
            modelBuilder.Entity("GameTrip.API.Data.GameTripUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameTrip.API.Data.LikedGame", b =>
                {
            ...
            modelBuilder.Entity("GameTrip.API.Data.LikedLocation", b =>
                {
            ...
            modelBuilder.Entity("GameTrip.API.Data.Location", b =>
                {
            ...
            modelBuilder.Entity("GameTrip.API.Data.Picture", b =>
                {
            ...
            modelBuilder.Entity("GameLocation", b =>
                {
                    b.HasOne("GameTrip.API.Data.Game", null)
                        .WithMany()
                        .HasForeignKey("GamesIdGame")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameTrip.API.Data.Location", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameTrip.API.Data.Comment", b =>
                {
                    b.HasOne("GameTrip.API.Data.Location", "Location")
                        .WithMany("Comments")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameTrip.API.Data.GameTripUser", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("GameTrip.API.Data.LikedGame", b =>
                {
                    b.HasOne("GameTrip.API.Data.Game", "Game")
                        .WithMany("LikedGames")
